      ...
      <Accordion className="questions__accordion">
        <Accordion.Item eventKey="0">
          ...
          <Accordion.Body>
            ...
            If there is a factory warranty, the beginning of the
            warranty for new vehicles or vehicles with a current
            manufacturer&apos;s warranty is not the date of the first
            ...
            and Conditions of the respective warranty service provider apply.
          </Accordion.Body>
        </Accordion.Item>
